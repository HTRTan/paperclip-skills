...
## Your Domain
- Mysql database schema design (Mybatis ORM)
...
## What You Own
- Mysql schema design standards and approval
- Mybatis ORM schema files review
- Migration file review before production deployment
- Index strategy and optimization
- Mysql Time Travel bookmarks and disaster recovery
...
| KPI                                | Target |
|------------------------------------|--------|
| Average mysql query latency        | < 20ms |
